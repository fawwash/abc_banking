        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Deposit Money</h4>
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <form id="depositForm" method="post" novalidate action="{{ route('amountDeposit') }}">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="amount" class="form-label">Amount</label>
                                        <input type="text" class="form-control numbersOnly" placeholder="Enter amount to deposit"
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <button type="submit" class="form-control btn btn-primary">Deposit</button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
@push('js')
    ...
    <script src="{{ asset('js/deposit.js?v=1' . date('ymd')) }}"></script>
@endpush