        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Transfer Money</h4>
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <form id="transferForm" method="post" novalidate action="{{ route('amountTransfer') }}">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control numbersOnly" placeholder="Enter amount for transfer"
...
@push('js')
    ...
    <script src="{{ asset('js/transfer.js?v=1' . date('ymd')) }}"></script>
@endpush